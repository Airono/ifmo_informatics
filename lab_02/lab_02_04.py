...
season2 = season.encode("utf-8")
print(season2)
season2 = season2.decode("utf-8")
print(season2)


poem = "When shall we three meet again; In thunder, lightning, or in rain?"
poem = poem.replace("thunder", "C")
poem = poem.replace("lightning", "Erling")
poem = poem.replace("in rain", "Java main")
print(poem)
